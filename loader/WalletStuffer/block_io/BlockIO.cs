...
namespace block_io_sharp
{
    public class BlockIO
    {
        ...
        /// <summary>
        /// Returns all the addresses, their labels, and user ids on your account. must specify 'addresses' or 'labels'. (Can also be used to query non-Account Addresses)
        /// </summary>
        /// <returns>APIResponse</returns>
        ...
        /// <summary>
        /// Estimates network fee required to perform a Withdraw transaction
        /// </summary>
        /// <returns></returns>
        public APIResponse getNetworkFeeEstimate(List<string> Amounts, List<string> Addresses)
        {
            NameValueCollection Params = System.Web.HttpUtility.ParseQueryString(string.Empty);
            ...
            return apiCall("get_network_fee_estimate", Params);
        }
