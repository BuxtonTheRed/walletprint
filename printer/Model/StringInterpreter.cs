...
namespace Casascius.Bitcoin {
    ...
    public class StringInterpreter {
        ...
        /// </summary>
        public static List<object> InterpretBatch(string what, bool compressed = false, byte addressType = 30) { // changed default addressType for DOGE conversion
        ...
        /// </summary>
        public static object Interpret(string what, bool compressed = false, byte addressType = 30) { // changed default addressType for DOGE conversion
